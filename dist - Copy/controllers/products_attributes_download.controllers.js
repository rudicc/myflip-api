...
exports.delete_products_attributes_download = exports.put_products_attributes_download = exports.port_products_attributes_download = exports.get_products_attributes_download_byid = exports.get_products_attributes_download_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_products_attributes_download_all(req, res) {
...
exports.get_products_attributes_download_all = get_products_attributes_download_all;
function get_products_attributes_download_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_products_attributes_download_byid = get_products_attributes_download_byid;
function port_products_attributes_download(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_products_attributes_download = port_products_attributes_download;
function put_products_attributes_download(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_products_attributes_download = put_products_attributes_download;
function delete_products_attributes_download(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_products_attributes_download = delete_products_attributes_download;
