...
exports.delete_customers_basket = exports.put_customers_basket = exports.port_customers_basket = exports.get_customers_basket_byid = exports.get_customers_basket_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_customers_basket_all(req, res) {
...
exports.get_customers_basket_all = get_customers_basket_all;
function get_customers_basket_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_customers_basket_byid = get_customers_basket_byid;
function port_customers_basket(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_customers_basket = port_customers_basket;
function put_customers_basket(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_customers_basket = put_customers_basket;
function delete_customers_basket(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_customers_basket = delete_customers_basket;
