...
exports.delete_orders_status = exports.put_orders_status = exports.port_orders_status = exports.get_orders_status_byid = exports.get_orders_status_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_orders_status_all(req, res) {
...
exports.get_orders_status_all = get_orders_status_all;
function get_orders_status_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_orders_status_byid = get_orders_status_byid;
function port_orders_status(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_orders_status = port_orders_status;
function put_orders_status(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_orders_status = put_orders_status;
function delete_orders_status(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_orders_status = delete_orders_status;
