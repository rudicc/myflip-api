...
exports.delete_users_type = exports.put_users_type = exports.port_users_type = exports.get_users_type_byid = exports.get_users_type_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_users_type_all(req, res) {
...
exports.get_users_type_all = get_users_type_all;
function get_users_type_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_users_type_byid = get_users_type_byid;
function port_users_type(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_users_type = port_users_type;
function put_users_type(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_users_type = put_users_type;
function delete_users_type(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_users_type = delete_users_type;
