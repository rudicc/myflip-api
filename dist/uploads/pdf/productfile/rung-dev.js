...
document.querySelector("#zoomin").addEventListener("click", function () { 
            book.style.width = `${vzoom++}px`; // "550px";
            book.style.height = `${vzoom+1+150}px`; //"700px";
});
document.querySelector("#zoomout").addEventListener("click", function () { 
    book.style.width = vzoom--; // "550px";
    book.style.height = (vzoom--)-150; //"700px";
});
    //Business Logic
    ...
    function setPagenum(value){
        //vpanum
        document.querySelector("#vpanum").value = value;
    }
    function goPrevPage() {
        //debugger
        if (currentLoacation > 1) {     
    ...
    async function MoveDataFilp(p){
        ...
        try{
            document.getElementById("vdatacss").innerHTML ="";
            this.vdatacss = "";
            //31*2 -1 = 61,62
            //32*2 -1 = 63,64
            //33*2 -1 = 65,66
