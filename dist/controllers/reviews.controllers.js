...
exports.delete_reviews = exports.put_reviews = exports.port_reviews = exports.get_reviews_byid = exports.get_reviews_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_reviews_all(req, res) {
...
exports.get_reviews_all = get_reviews_all;
function get_reviews_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_reviews_byid = get_reviews_byid;
function port_reviews(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_reviews = port_reviews;
function put_reviews(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_reviews = put_reviews;
