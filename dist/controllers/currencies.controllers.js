...
exports.delete_currencies = exports.put_currencies = exports.port_currencies = exports.get_currencies_byid = exports.get_currencies_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_currencies_all(req, res) {
...
exports.get_currencies_all = get_currencies_all;
function get_currencies_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_currencies_byid = get_currencies_byid;
function port_currencies(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_currencies = port_currencies;
function put_currencies(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_currencies = put_currencies;
function delete_currencies(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_currencies = delete_currencies;
