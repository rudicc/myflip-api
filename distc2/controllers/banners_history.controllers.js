...
exports.delete_banners_history = exports.put_banners_history = exports.port_banners_history = exports.get_banners_history_byid = exports.get_banners_history_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_banners_history_all(req, res) {
...
exports.get_banners_history_all = get_banners_history_all;
function get_banners_history_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_banners_history_byid = get_banners_history_byid;
function port_banners_history(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_banners_history = port_banners_history;
function put_banners_history(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_banners_history = put_banners_history;
function delete_banners_history(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_banners_history = delete_banners_history;
