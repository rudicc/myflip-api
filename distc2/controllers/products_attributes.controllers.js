...
exports.delete_products_attributes = exports.put_products_attributes = exports.port_products_attributes = exports.get_products_attributes_byid = exports.get_products_attributes_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_products_attributes_all(req, res) {
...
exports.get_products_attributes_all = get_products_attributes_all;
function get_products_attributes_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_products_attributes_byid = get_products_attributes_byid;
function port_products_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_products_attributes = port_products_attributes;
function put_products_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_products_attributes = put_products_attributes;
function delete_products_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_products_attributes = delete_products_attributes;
