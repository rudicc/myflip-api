...
exports.delete_orders = exports.put_orders = exports.port_orders = exports.get_orders_byid = exports.get_orders_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_orders_all(req, res) {
...
exports.get_orders_all = get_orders_all;
function get_orders_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_orders_byid = get_orders_byid;
function port_orders(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_orders = port_orders;
function put_orders(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_orders = put_orders;
function delete_orders(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
