...
exports.delete_configuration_group = exports.put_configuration_group = exports.port_configuration_group = exports.get_configuration_group_byid = exports.get_configuration_group_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_configuration_group_all(req, res) {
...
exports.get_configuration_group_all = get_configuration_group_all;
function get_configuration_group_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_configuration_group_byid = get_configuration_group_byid;
function port_configuration_group(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_configuration_group = port_configuration_group;
function put_configuration_group(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_configuration_group = put_configuration_group;
function delete_configuration_group(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_configuration_group = delete_configuration_group;
