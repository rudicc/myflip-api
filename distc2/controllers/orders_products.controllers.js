...
exports.delete_orders_products = exports.put_orders_products = exports.port_orders_products = exports.get_orders_products_byid = exports.get_orders_products_byordersid_cutomerid = exports.get_orders_products_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_orders_products_all(req, res) {
...
exports.get_orders_products_all = get_orders_products_all;
function get_orders_products_byordersid_cutomerid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.get_orders_products_byordersid_cutomerid = get_orders_products_byordersid_cutomerid;
function get_orders_products_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_orders_products_byid = get_orders_products_byid;
function port_orders_products(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_orders_products = port_orders_products;
function put_orders_products(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_orders_products = put_orders_products;
function delete_orders_products(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_orders_products = delete_orders_products;
