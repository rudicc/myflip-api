...
exports.delete_customers_basket_attributes = exports.put_customers_basket_attributes = exports.port_customers_basket_attributes = exports.get_customers_basket_attributes_byid = exports.get_customers_basket_attributes_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_customers_basket_attributes_all(req, res) {
...
exports.get_customers_basket_attributes_all = get_customers_basket_attributes_all;
function get_customers_basket_attributes_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_customers_basket_attributes_byid = get_customers_basket_attributes_byid;
function port_customers_basket_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_customers_basket_attributes = port_customers_basket_attributes;
function put_customers_basket_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_customers_basket_attributes = put_customers_basket_attributes;
function delete_customers_basket_attributes(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_customers_basket_attributes = delete_customers_basket_attributes;
