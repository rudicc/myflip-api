...
exports.delete_manufacturers_info = exports.put_manufacturers_info = exports.port_manufacturers_info = exports.get_manufacturers_info_byid = exports.get_manufacturers_info_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_manufacturers_info_all(req, res) {
...
exports.get_manufacturers_info_all = get_manufacturers_info_all;
function get_manufacturers_info_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_manufacturers_info_byid = get_manufacturers_info_byid;
function port_manufacturers_info(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_manufacturers_info = port_manufacturers_info;
function put_manufacturers_info(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_manufacturers_info = put_manufacturers_info;
function delete_manufacturers_info(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_manufacturers_info = delete_manufacturers_info;
