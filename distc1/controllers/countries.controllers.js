...
exports.delete_countries = exports.put_countries = exports.port_countries = exports.get_countries_byid = exports.get_countries_all = void 0;
const mydbcommand_1 = require("../dbconfig/mydbcommand");
function get_countries_all(req, res) {
...
exports.get_countries_all = get_countries_all;
function get_countries_byid(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.get_countries_byid = get_countries_byid;
function port_countries(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.port_countries = port_countries;
function put_countries(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
            const item = req.body;
...
exports.put_countries = put_countries;
function delete_countries(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const conn = yield (0, mydbcommand_1.connect)();
...
exports.delete_countries = delete_countries;
